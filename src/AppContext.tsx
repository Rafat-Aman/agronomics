...
const translations = {
  en: {
    ...
    fieldRequired: 'Please select a field to get AI recommendations.',
    prevRecommendations: 'Previous AI Recommendations',
    noRecsForField: 'No AI recommendations for this field yet.',
  ...
  bn: {
    ...
    fieldRequired: 'এআই সুপারিশ পেতে একটি জমি নির্বাচন করুন।',
    prevRecommendations: 'পূর্ববর্তী এআই সুপারিশ',
    noRecsForField: 'এই জমির জন্য এখনো কোনো সুপারিশ নেই।',
